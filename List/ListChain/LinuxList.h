...
static  void __list_add(struct list_head *new1,
 ...
 */
static  void list_add(struct list_head *new1, struct list_head *head)
{
 ...
 */
static  void list_add_tail(struct list_head *new1, struct list_head *head)
{
...
static  void list_replace_init(struct list_head* old,struct list_head* new1)
{
 ...
 */
static  void hlist_move_list(struct hlist_head *old,struct hlist_head *new1)
{
